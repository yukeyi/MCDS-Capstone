...
def get_classtable():
    classes = []
    with open("samples/street.txt") as lines:
        for line in lines:
...
def demo1(image_paths, target_layer, arch, topk, output_dir, cuda):
    ...
    path = "/pylon5/ac5616p/faqian/ddsm-visual-primitives/training/checkpoints/2019-04-23_18-58-42.755288_resnet18/checkpoint_00000026.pth.tar"
    resume_path = path.replace(path[-16:-8], '{:08}'.format(26))
